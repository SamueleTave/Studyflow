...
const SF_ROLES = [
  { min:   0, key: 'novizio',
    ...
    grad: ['#9ca3af','#6b7280'], coinBonus: 5,
    perk: 'Punto di partenza',
    perks: ['⏱ Timer Pomodoro base', '<svg width="11" height="11" viewBox="0 0 16 16" fill="#F59E0B" style="vertical-align:middle;display:inline-block"><circle cx="8" cy="8" r="8"/><circle cx="8" cy="8" r="5" fill="#D97706"/><circle cx="8" cy="8" r="3" fill="#F59E0B"/></svg> 5 monete per sessione'] },

  { min:   1, key: 'studente',
    emoji: '📖', name: 'Studente',
    color: '#3b82f6', bg: 'rgba(59,130,246,0.13)',
    grad: ['#60a5fa','#3b82f6'], coinBonus: 5,
    perk: 'Widget Citazione sbloccato',
    perks: ['💬 Widget Citazione motivazionale', '<svg width="11" height="11" viewBox="0 0 16 16" fill="#F59E0B" style="vertical-align:middle;display:inline-block"><circle cx="8" cy="8" r="8"/><circle cx="8" cy="8" r="5" fill="#D97706"/><circle cx="8" cy="8" r="3" fill="#F59E0B"/></svg> 5 monete per sessione', '🤝 Accesso alle sfide amici'] },

  { min:  25, key: 'applicato',
    emoji: '🎯', name: 'Applicato',
    color: '#8b5cf6', bg: 'rgba(139,92,246,0.13)',
    grad: ['#a78bfa','#8b5cf6'], coinBonus: 6,
    perk: 'Tema Viola sbloccato',
    perks: ['🎨 Tema Viola e Smeraldo', '🐰 Coniglio compagno', '<svg width="11" height="11" viewBox="0 0 16 16" fill="#F59E0B" style="vertical-align:middle;display:inline-block"><circle cx="8" cy="8" r="8"/><circle cx="8" cy="8" r="5" fill="#D97706"/><circle cx="8" cy="8" r="3" fill="#F59E0B"/></svg> 6 monete per sessione', '📊 Statistiche avanzate'] },

  { min:  75, key: 'determinato',
    emoji: '🔥', name: 'Determinato',
    color: '#f97316', bg: 'rgba(249,115,22,0.15)',
    grad: ['#fb923c','#f97316'], coinBonus: 7,
    perk: 'Animali interattivi sbloccati',
    perks: ['🔥 Animali interattivi sbloccati', '⚡ Sfide premium accesso', '<svg width="11" height="11" viewBox="0 0 16 16" fill="#F59E0B" style="vertical-align:middle;display:inline-block"><circle cx="8" cy="8" r="8"/><circle cx="8" cy="8" r="5" fill="#D97706"/><circle cx="8" cy="8" r="3" fill="#F59E0B"/></svg> 7 monete per sessione', '🏅 Badge fuoco in classifica'] },

  { min: 150, key: 'studioso',
    emoji: '⭐', name: 'Studioso',
  ...
  { min: 450, key: 'esperto',
    ...
    grad: ['#22d3ee','#06b6d4'], coinBonus: 9,
    perk: 'Tutti gli animali sbloccati',
    perks: ['💎 Tutti gli animali premium', '📐 Widget taglia XL', '<svg width="11" height="11" viewBox="0 0 16 16" fill="#F59E0B" style="vertical-align:middle;display:inline-block"><circle cx="8" cy="8" r="8"/><circle cx="8" cy="8" r="5" fill="#D97706"/><circle cx="8" cy="8" r="3" fill="#F59E0B"/></svg> 9 monete per sessione', '✨ Frame speciale profilo classifica'] },

  { min: 800, key: 'maestro',
    emoji: '🏆', name: 'Maestro',
    color: '#f59e0b', bg: 'rgba(245,158,11,0.18)',
    grad: ['#fcd34d','#f59e0b'], coinBonus: 10,
    perk: 'Tutto sbloccato — titolo esclusivo',
    perks: ['👑 Titolo Maestro nel profilo', '🏆 Bordo oro in classifica', '<svg width="11" height="11" viewBox="0 0 16 16" fill="#F59E0B" style="vertical-align:middle;display:inline-block"><circle cx="8" cy="8" r="8"/><circle cx="8" cy="8" r="5" fill="#D97706"/><circle cx="8" cy="8" r="3" fill="#F59E0B"/></svg> 10 monete per sessione', '🎁 Tutto sbloccato per sempre'] },
];
